...
public class HorizontalFlag extends Flag {
    ...
    /**
     * Constructs a new HorizontalFlag object by copying another HorizontalFlag object.
     * 
	...
	/**
	 * Generates the string array representing the horizontal flag with the coat of arms.
	 * This method constructs the flag design by combining the coat of arms pattern with background colors,
	 * ensuring alignment and distribution of colors across the flag's height.
	 *
    ...
    /**
     * Resizes the flag to the specified width and height and adjusts the size of the coat of arms accordingly.
     * 
    ...
    /**
     * Provides information about the HorizontalFlag, including its dimensions and the coat of arms.
     */
	@Override
	public void info() {
